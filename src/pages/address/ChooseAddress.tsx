...
interface RedirectProps {
  props: any // props to pass
  route: string
  name: string // name for prop to place address in
}

const ChooseAddressPage = (user: App.UserAppData & App.PageProps) => {
  const [addresses, setAddresses] = useState<Address.AddressData[]>(null),
    redirect = (user.route.params) as RedirectProps, // if this is present, it will be passed to the navigation pages
